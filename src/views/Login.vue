                    ...
                    <div class="card-body">
                        ...
                        <form class="form-signin">
                            <div class="form-group">
                                ...
                                data-i18n-placeholder="login-account-hint" placeholder="帳號: abcd@email.com" autofocus>
                            </div>

                            <div class="form-group">
                                <input type="password" id="inputPassword" class="form-control" data-i18n-placeholder="login-password-hint" placeholder="密碼">
                                <span><a href="PasswordForget"><small class="pl-1 text-secondary" data-i18n="login-forget">忘記密碼？</small></a></span>
                                ...
                                <div>
                                    <a class="text-muted" href="regist.html">
                                        <small>
                                            ...
                                            <span class="text-primary pointer" data-i18n="login-regist">註冊</span>
                                            </router-link>
                                        </small>
                                    </a>
                                </div>
                          ...
                          <button class="btn btn-lg btn-primary btn-block form-main-btn" onclick="login()" data-i18n="login">
                                登入
                          </button>
